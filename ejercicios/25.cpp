// Dados dos arreglos sin repetidos, calcule el arreglo que resulta de la intersección entre los elementos de los otros dos arreglos. Este último debe ser definido del tamaño exacto.
