# Solución ejercicios C++


Repositorio que contiene el código de solución de los ejercicios de C++ de la clase de Introducción a las Ciencias de la Computación de la Universidad Nacional de Colombia.

Vi esta materia y elaboré la solución de los ejercicios en el segundo semestre del 2024. Para mi sorpresa, a día de hoy suelo utilizar este código! Los ejercicios plantean desafíos comúnes a la hora de programar, como (completar). Los códigos, más que una solución genérica, los uso a manera de apuntes, para recordar la estructura en que se programa en C++ y una qeue otra función útil que se me suele olvidar.
